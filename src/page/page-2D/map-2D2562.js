    ...
    const map = useMapEvents({
      click: (e) => {
        ...
        const data = { lat: lat.toFixed(5) , lng: lng.toFixed(5)};
          ...
          axios.post("http://localhost:3001/getData2562",data).then((res,err) => {
          ...
          <div className='cardContent'>
            <div className='col-12'>
              <div className='row dataContent' >
                <div className='col'>
                  {/* <label htmlFor='selectYear' className='font-label-header'>Year</label>
                ...
                <DropdownButton id="dropdown-basic-button" title="2562">
